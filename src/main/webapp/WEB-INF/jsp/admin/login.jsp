...
<body>
    ...
    <section id="main" class="page-login">
        <div class="container_12">
			...
			<form class="registed" action="/shop/dologinadm" method="post" >
			    <h2>登录</h2>
			    <!-- <p>若您已有账号，请登录</p> -->
			    <p>${loginMsg}</p>
			    <div class="text">
				<strong>用户名:</strong><sup>*</sup><br>
				<input type="text" name="userName" class="" value="${admName }">
			    </div><!-- .userName -->
			    <div class="password">
				<strong>密码:</strong><sup>*</sup><br>
				<input type="password" name="userPwd" class="" value="${admPwd }">
			    </div><!-- .userPwd -->
			    <div class="remember">
